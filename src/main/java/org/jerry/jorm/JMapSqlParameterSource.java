 ...
 */
public class JMapSqlParameterSource extends AbstractSqlParameterSource {
     ...
     * @see #addValue(String, Object)
     */
    public JMapSqlParameterSource(String paramName, Object value) {
     ...
     */
    public JMapSqlParameterSource(Map<String, ?> values) {
        addValues(values);
    }
     ...
     */
    public JMapSqlParameterSource addValue(String paramName, Object value) {
     ...
     * so it's possible to chain several calls together
     */
    public JMapSqlParameterSource addValue(String paramName, Object value, int sqlType) {
        Assert.notNull(paramName, "Parameter name must not be null");
        this.values.put(paramName, value);
     ...
     * so it's possible to chain several calls together
     */
    public JMapSqlParameterSource addValue(String paramName, Object value, int sqlType, String typeName) {
        Assert.notNull(paramName, "Parameter name must not be null");
        this.values.put(paramName, value);
        registerSqlType(paramName, sqlType);
     ...
     * so it's possible to chain several calls together
     */
    public JMapSqlParameterSource addValues(Map<String, ?> values) {
        if (values != null) {
    ...
    public Object getValue(String paramName) {
        ...
        Object value = this.values.get(paramName);
